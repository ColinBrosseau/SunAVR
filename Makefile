...
SRC = $(TARGET).c    # add all .c files here
...
#
AVRDUDE_PROGRAMMER = stk500v1    # adapt to programmer's type
...
# Program the device (Arduino style programmer)  
program2: $(TARGET).hex $(TARGET).eep
	$(AVRDUDE) $(AVRDUDE_FLAGS) $(AVRDUDE_WRITE_FLASH) $(AVRDUDE_WRITE_EEPROM)

# Program the device (butterfly bootloader)
program: # adjust speed
	avrdude -p $(MCU) -c butterfly v -b 57600 -F -P $(AVRDUDE_PORT) -U flash:w:main.hex
